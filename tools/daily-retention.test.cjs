...
const promiseEcho=Daily.queueEcho(echoes,{today:'2026-08-03',rid:7,kind:'promise:run-7',runId:'run-7',promiseId:'fandom',promiseTitle:'플리와 앙코르 약속',promiseStatus:'failed'});
