...
need(finish.includes('if(!_dg.persisted)')&&finish.includes('this._finished=false')&&finish.includes("dgT('save.reopen')"),'failed completion must stay retryable and avoid permanent-reward UI');
